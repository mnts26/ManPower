...
(function($) {
    $.flexbox = function(div, o) {
        ...
        var left = ($.browser.msie && $.browser.version.substr(0, 1) === '6')
            ? -(o.width  + arrowWidth + 23)
            : 0;
        var width =  ($.browser.msie && $.browser.version.substr(0, 1) === '6')
        ? (o.width  + arrowWidth + 21) + 'px'
                : (o.width + 2) + 'px';
        
        var $ctr = $(document.createElement('div'))
            .attr('id', $div.attr('id') + '_ctr')
            .css('width', width) // TODO: The -2 here might be because of the border... try to fix
            .css('top', 22)
            .css('left', left)
            ...
            .hide();
//        alert("left :" + left);
//        alert("width :" + (o.width + arrowWidth - 2) + 'px');
    ...
    $.fn.flexbox.defaults = {
        ...
        noResultsListener : function(){}, // default is nothing todo.. for jacara's usage.
        paging: {
